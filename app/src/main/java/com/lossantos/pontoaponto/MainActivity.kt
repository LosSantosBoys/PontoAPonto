...
fun CreateAccountLink(modifier: Modifier = Modifier) {
    val annotatedText = buildAnnotatedString {
        ...
        withStyle(style = MaterialTheme.typography.labelSmall.copy(fontWeight = FontWeight.Bold).toSpanStyle()) {
            append("Crie uma.")
        }
        pop()
    }
...
@Composable
fun AppNameWithImagePreview() {
    AppNameWithImage()
}

@Preview(showBackground = true)
@Composable
fun LoginWithGooglePreview(modifier: Modifier = Modifier) {
    val googleIcon = painterResource(R.drawable.google_icon)
